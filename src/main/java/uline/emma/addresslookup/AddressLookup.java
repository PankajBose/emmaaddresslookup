...
public class AddressLookup {
    ...
    public static String update(@RequestParam(required = false) String date) {
       ...
       //             "where c.sitename in ('global') and startswith(c.displayname, 'jake drew',true)", new CosmosQueryRequestOptions(), SiteBean.class);
        ...
        CosmosPagedIterable<Object> emptyCount = container.queryItems("SELECT COUNT(1) ItemCount FROM addressbook c " +
